...
<script>
  ...
  gtag('config', 'G-T5V03S2YS9');
   ...
   (async()=>{let visitorcount=await (await fetch("https://visitorcounts.haru-ymth.repl.co",{method:"POST",body:JSON.stringify({url:locaton.origin+location.pathname})})).text();
